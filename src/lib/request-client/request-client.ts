...
import qs from "qs";
import { bindMethods, isString } from "@/utils";
 ...
 * @example
 * getParamsSerializer("brackets")(params) => ids[]=1&ids[]=2&ids[]=3
 * getParamsSerializer("comma")(params) => ids=1,2,3
 * getParamsSerializer("indices")(params) => ids[0]=1&ids[1]=2&ids[2]=3
 * getParamsSerializer("repeat")(params) => ids=1&ids=2&ids=3
 * getParamsSerializer("default")(params) => ids[]=1&ids[]=2&ids[]=3
 */
