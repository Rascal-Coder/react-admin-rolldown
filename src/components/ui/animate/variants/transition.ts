...
export const varTranHover = (props?: TranHoverType) => {
  ...
  const ease = props?.ease || ([0.43, 0.13, 0.23, 0.96] as const);
...
export const varTranEnter = (props?: TranEnterType) => {
  ...
  const ease = props?.easeIn || ([0.43, 0.13, 0.23, 0.96] as const);
...
export const varTranExit = (props?: TranExitType) => {
  ...
  const ease = props?.easeOut || ([0.43, 0.13, 0.23, 0.96] as const);
