  ...
  const screenReaderInstructions: ScreenReaderInstructions =
    React.useMemo(() => {
      ...
      if (orientation === "vertical") {
        keyDirection = "up and down";
      } else if (orientation === "horizontal") {
        keyDirection = "left and right";
      } else {
        keyDirection = "arrow";
      }
      ...
      return {
        ...
        While dragging, use the ${keyDirection} keys to move the item.
...
const SortableContent = (
  props: SortableContentProps & { ref?: React.Ref<HTMLDivElement> }
) => {
  const {
...
const SortableItem = (
  props: SortableItemProps & { ref?: React.Ref<HTMLDivElement> }
) => {
  const {
    value,
    style,
...
const SortableItemHandle = (
  props: SortableItemHandleProps & { ref?: React.Ref<HTMLButtonElement> }
) => {
  const {
    asChild,
    disabled,
...
function SortableOverlay(props: SortableOverlayProps) {
  ...
  if (context.activeId) {
    if (typeof children === "function") {
      overlayContent = children({ value: context.activeId });
    } else {
